/*
To perform paper "Broad cross-reactivity of the T-cell repertoire achieves specific and sufficiently rapid target sea$
...

{
    ...
    double pair_E;
    int pair_len;
    int tcr_min=4;//position 5  of tcr
    int tcr_max=9;//position 10 of tcr
    ...
    ofstream file;
    file.open("countP.dat");       // write the file
    //output: format
    file.precision(6);
...
//Read MJ-matrix and a.a. frequency of TCR (human and mice) and listeria peptide data
